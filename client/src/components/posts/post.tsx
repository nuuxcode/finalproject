      ...
      <div className="flex justify-between items-center">
        <div className="flex gap-2 items-center py-2">
          ...
          <div className="flex flex-col justify-center">
            <Link href={`/forum/${post.forum.slug}`} className="dark:text-primary text-sm hover:underline cursor-pointer">
              <span className="dark:text-yellow-500">Forum: </span>{post.forum.name}
            </Link>
            <Link
              href={`/${post.user.username}`}
              className="dark:text-primary hover:text-primary font-[500] text-xs hover:underline cursor-pointer"
            >
              <span className="dark:text-yellow-500">Author: </span>{post.user.username}
            </Link>
          </div>
        </div>
        <Popover>
